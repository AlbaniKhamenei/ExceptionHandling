...
public class MultipleCatch {
    public static void main(String[] args){
        ...
        try {
            int[] array= new int[9]; //deklarasiarray berukuran 9 buah elemen
            ...
            System.err.println("Anda mengakses array di luar indeks deklarasikan.");
        }
        catch (NegativeArraySizeException exc){
            System.err.println("Anda mendeklarasikan array dengan ukuran negatif.");
        }
        catch (Exception exc){
            System.err.println("Anda melakukan pembagian bilangan nol.");
        }
    }
}
